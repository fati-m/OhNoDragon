...
/**
 * This class defines functions of all character types
 */
public class Character {
  ...
  public Character(Room currentRoom, String label) {
    // throws exception for null currentRoom field
    if (currentRoom == null) {
      throw new IllegalArgumentException("currentRoom is null");
    }
    this.currentRoom = currentRoom; // initialize field
    this.label = label; // initialize field
  }
